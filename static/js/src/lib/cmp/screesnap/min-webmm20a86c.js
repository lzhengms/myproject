    ...
    k.prototype = {option: function (a, b) {
        ...
        function c(a) {
            ...
            for (var k = 0; k < h.length; k++) {
                var j = h[k];
                j != e._moElement$.size() && b.trigger(j, i, [
                    {state: e._mnState, cursorPos: a, pos: g.getPos(e._moMover$)}
                ])
            }
        }
...
(function (b, c) {
    ...
    e.prototype = {setImg: function (b) {
        ...
        var o = [
            [b("#rUp_" + f, a._moDocument)[0], "top"],
            [b("#rLeft_" + f, a._moDocument)[0], "left"],
            [b("#rDown_" + f, a._moDocument)[0], "bottom"],
            [b("#rRight_" + f, a._moDocument)[0], "right"],
            [b("#rLeftUp_" + f, a._moDocument)[0], "left-top"],
            [b("#rLeftDown_" + f, a._moDocument)[0], "left-bottom"],
            [b("#rRightUp_" + f, a._moDocument)[0], "right-top"],
            [b("#rRightDown_" + f, a._moDocument)[0], "right-bottom"]
        ];
...
(function (b, c, f, g) {
    ...
    c.model("message", {getMessages: function (a) {
        ...
        this.addMessages([
            {MsgId: b.now(), MsgType: a.MsgType, FromUserName: a.FromUserName, ToUserName: a.ToUserName, Status: c.Constants.STATE_SENT, CreateTime: a.CreateTime || c.util.getServerTime() / 1E3, Content: a.Content, unread: !1}
        ])
        ...
        if (a && !c.util.isShieldUser(a)) {
            ...
            this.addMessages([
                {MsgId: this.idIndex++, MsgType: d, FromUserName: "", ToUserName: a, Status: c.Constants.STATE_SENT, CreateTime: b ? b : c.util.getServerTime() / 1E3, Content: e, unread: !1}
            ]);
            return!0
        }
                ...
                if (!(p.MsgType == c.Constants.MM_DATA_STATUSNOTIFY || c.util.isTalkContact(u) || c.util.isTalkContact(E) || c.util.isShieldUser(u) || c.util.isShieldUser(E) || p.MsgType == c.Constants.MM_DATA_VERIFYMSG && p.RecommendInfo && p.RecommendInfo.UserName == c.model("account").getUserInfo().UserName)) {
                    if (p.MsgType == c.Constants.MM_DATA_RECALLED) {
                        ...
                        if (u = e(v, p.MsgId), 0 > u) {
                            ...
                            var v = "", F = this;
                            1 == p.isChatRoom ? (v = p.FromUserName.replace("@chatroom", ""), WebMM.model("contact").getChatroomContact(v, p.actualSender) ? (v = c.util.getMemberDisplayName(p.actualSender, v), this.showMessage(v, p, n)) : b.netQueue().send("/cgi-bin/mmwebwx-bin/webwxbatchgetcontact?type=ex", b.extend(WebMM.model("account").getBaseRequest(), {Count: 1, List: [
                                {UserName: p.actualSender, ChatRoomId: v}
