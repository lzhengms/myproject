module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        jshint: {
            ...
            useDefault: ['js/app/*.js', 'js/app/**/*.js', '!js/app/**/tpl/*.js', '!js/app/**/*Tpl.js']
        },
        // 转化
        transport: {
            options: {
            ...
            jquery:{
                files: [
                    {
                        cwd: 'public/js/jquery',
                        expand:true,
                        src: 'jquery.jplayer.js',
                        dest: '.build'
                    }
                ]
            }
    ...
    //'transport:jquery', 'concat:jquery',
    //grunt.registerTask('default', ['uglify:jquery']);
};